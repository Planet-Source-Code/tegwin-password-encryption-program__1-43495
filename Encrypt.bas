...
' This is the encryption alogrithum was not written by me, I found it on
' PSC and so credit to whomever wrote it.
...
Function crypt(ByVal Key As String, ByVal inp As String) As String
crypt = ""
si = 0
x1a2 = 0
i = 0
...
Function decrypt(ByVal Key As String, ByVal inp As String) As String
decrypt = ""
si = 0
x1a2 = 0
i = 0
